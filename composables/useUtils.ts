 ...
 * @returns
 */
const formatDatetime = function (date: Date = new Date(), fmt: string = 'yyyy-MM-dd hh:mm:ss'): string {
 ...
 * @returns { string }
 */
const toChineseNumber = function (s: string): string {
    const num = s
 ...
 */
const cut = function (str: string, length: number): string {
